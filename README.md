...
and should also work for Centos 8.
...
avalon-sync.conf should contain the following modified to match your environment's
details:
...
> *You could also run db_sync.py from cron if you wished, although that is not
> covered here.*  
...
The above will limit the Avalon Sync scripts to collectively never use
more than 50% of the CPU or more than 1.2G of the RAM on your server.
